...
export const LandingPage: React.FC = () => {
    ...
    // Estados para PERFORMANCE e CONTEÚDO
    const [isPageLoading, setIsPageLoading] = useState(true);
    const [siteContent, setSiteContent] = useState<Record<string, string>>({}); // { "section:key": "content" }
    ...
    // Carregamento em lote de TODO o conteúdo do site
    useEffect(() => {
        const fetchAllContent = async () => {
            try {
                // Busca tudo de uma vez para evitar múltiplas requisições
                ...
                // Só libera a tela quando os dados estiverem prontos
    ...
    // Helper para buscar o conteúdo injetado ou o padrão
    const getContent = (section: string, key: string, defaultValue: string) => {
        return siteContent[`${section}:${key}`] ?? defaultValue;
    };
    ...
    // Bloqueia a renderização enquanto carrega para evitar flicker do conteúdo default
    if (isPageLoading) {
                ...
                <div className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
                    ...
                    >
                        ...
                        <span className="text-slate-900 font-display font-bold text-xl sm:text-2xl tracking-tight">
                            <EditableContent
                                ...
                                defaultContent="Gama Center"
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('navbar', 'brand_name', 'Gama Center')}
                            />
                        </span>
                    </div>
                    <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-slate-600">
                        <a className="hover:text-primary transition-colors" href="#workflow">
                            <EditableContent
                                section="navbar"
                                contentKey="link_workflow"
                                defaultContent="Fluxo de Trabalho"
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('navbar', 'link_workflow', 'Fluxo de Trabalho')}
                            />
                        </a>
                        <a className="hover:text-primary transition-colors" href="#benefits">
                            <EditableContent
                                section="navbar"
                                contentKey="link_benefits"
                                defaultContent="Benefícios"
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('navbar', 'link_benefits', 'Benefícios')}
                            />
                        </a>
                        <a className="hover:text-primary transition-colors" href="#testimonials">
                            <EditableContent
                                section="navbar"
                                contentKey="link_testimonials"
                                defaultContent="Depoimentos"
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('navbar', 'link_testimonials', 'Depoimentos')}
                            />
                        </a>
                        <a className="hover:text-primary transition-colors" href="#pricing">
                            <EditableContent
                                section="navbar"
                                contentKey="link_pricing"
                                defaultContent="Preços"
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('navbar', 'link_pricing', 'Preços')}
                            />
                        </a>
                        <a className="hover:text-primary transition-colors" href="#faq">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('navbar', 'link_faq', 'FAQ')}
                            />
                        </a>
                    </div>
                    <button
                    ...
                    >
                        <EditableContent
                            section="navbar"
                            contentKey="btn_portal"
                            defaultContent="Portal do Cliente"
                            isEditing={editMode}
                            tagName="span"
                            initialContent={getContent('navbar', 'btn_portal', 'Portal do Cliente')}
                        />
                    </button>
                </div>
            </nav>
                    ...
                    <div className="space-y-8 animate-fade-in-up">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-wider">
                            ...
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('hero', 'chip_text', 'Software de Avaliação Psicossocial')}
                            />
                        </div>
                        <h1 className="font-display font-extrabold text-3xl sm:text-5xl lg:text-6xl text-slate-900 leading-[1.2] lg:leading-[1.15] break-words">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('hero', 'title_prefix', 'Melhore o ')}
                            />
                            <span className="text-primary relative inline-block">
                                <EditableContent
                                    ...
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('hero', 'title_highlight', 'Bem-estar dos Colaboradores')}
                                />
                            </span>
                            <EditableContent
                                section="hero"
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('hero', 'title_suffix', ' e Garanta a Conformidade Legal')}
                            />
                        </h1>
                        <p className="text-xl text-slate-600 max-w-lg leading-relaxed">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                initialContent={getContent('hero', 'subtitle', 'Uma plataforma humanocêntrica que simplifica avaliações de risco psicossocial, conectando psicologia profissional a relatórios automatizados.')}
                            />
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            ...
                            >
                                <EditableContent
                                    ...
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('hero', 'cta_primary', 'Entre em contato')}
                                />
                            ...
                            >
                                ...
                                <EditableContent
                                    ...
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('hero', 'cta_secondary', 'Ver Como Funciona')}
                                />
                            </button>
                        </div>
                    </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-[#D1D1D6] overflow-hidden transition-all duration-700">
                                ...
                                <div className="overflow-hidden bg-slate-50">
                                    <EditableContent
                                        ...
                                        initialContent={getContent('hero', 'hero_image', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAgTjHSNwimhOjpoOisnT7wa7gekhpGOYesZqHH8yIYL10CR4-xa56GHmLMVSgJ41DKGgCMYqkhkcHY9D4Zp3RXuLJf1ZSrKZm3hNNgTexDiwNtprmjaH94y5QO2wRLX0ptYcBxIaP7d1-ndg13xjAuiphQw6DlHQYn3OpvR_4xDAL8AQd1BgGpur-uct7h__9GooiWAoeqdZbhMz5qbEypZUT_iH5XGfWBGufM27VdtAkY2fewaQriLuFRWLtY_mjpvn4BkIkw-Gk')}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid lg:grid-cols-3 gap-12 relative z-10">
                            <div className="group text-center">
                                <div className="bg-white w-24 h-24 mx-auto rounded-full shadow-lg border-4 border-slate-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_1_icon"
                                        defaultContent="psychology_alt"
                                        isEditing={editMode}
                                        tagName="span"
                                        className="material-symbols-outlined text-4xl text-primary"
                                        initialContent={getContent('workflow', 'step_1_icon', 'psychology_alt')}
                                    />
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 mb-3">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_1_title"
                                        defaultContent="1. Avaliação"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('workflow', 'step_1_title', '1. Avaliação')}
                                    />
                                </h3>
                                <p className="text-slate-600 leading-relaxed px-4">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_1_description"
                                        defaultContent="Os colaboradores completam questionários psicológicos confidenciais e cientificamente embasados em qualquer dispositivo."
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('workflow', 'step_1_description', 'Os colaboradores completam questionários psicológicos confidenciais e cientificamente embasados em qualquer dispositivo.')}
                                    />
                                </p>
                                <div className="mt-6 p-3 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-[#D1D1D6] mx-auto max-w-xs transform group-hover:-translate-y-1 transition-all">
                                    <EditableContent
                                        ...
                                        alt="Assessment UI"
                                        initialContent={getContent('workflow', 'step_1_image', 'https://lh3.googleusercontent.com/aida-public/AB6AXuCUagg3zLkxqnADxdJyv_jpR2hbAbkCS3PGDVH95-h3ZZgabintTDoxiW741MCLW1VhiFrTxYUy6rNXZrebYY0m-1HplW0JNTIoD-Ssmum8jw_-DV0Qrt520x6G7qTY48DBNK3uEpcd53N-D35Lmq_yVuL1lTQ6yhp5WK6KbNDa2pySBmDNDdnLUgqw9VgbGrc03TV-QvSzryikpHPMHjnzKWy1IVBzlLaR0nAJ9HjdClOkQqNVSDYCdy0vvI-3NoZNpbM9SoF-27U')}
                                    />
                                </div>
                            </div>
                            <div className="group text-center">
                                <div className="bg-white w-24 h-24 mx-auto rounded-full shadow-lg border-4 border-slate-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_2_icon"
                                        defaultContent="analytics"
                                        isEditing={editMode}
                                        tagName="span"
                                        className="material-symbols-outlined text-4xl text-primary"
                                        initialContent={getContent('workflow', 'step_2_icon', 'analytics')}
                                    />
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 mb-3">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_2_title"
                                        defaultContent="2. Análise"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('workflow', 'step_2_title', '2. Análise')}
                                    />
                                </h3>
                                <p className="text-slate-600 leading-relaxed px-4">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_2_description"
                                        defaultContent="Nossos algoritmos processam os dados instantaneamente, identificando fatores de risco e mantendo o anonimato estrito."
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('workflow', 'step_2_description', 'Nossos algoritmos processam os dados instantaneamente, identificando fatores de risco e mantendo o anonimato estrito.')}
                                    />
                                </p>
                                <div className="mt-6 p-3 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-[#D1D1D6] mx-auto max-w-xs transform group-hover:-translate-y-1 transition-all">
                                    <EditableContent
                                        ...
                                        initialContent={getContent('workflow', 'step_2_image', 'https://lh3.googleusercontent.com/aida-public/AB6AXuCdWOC4G_GFtfv0oG9USegnMJWsp5JpEkR3tWgkoOFKiFyVu9yzBnMOZfpUVPxKF5cmzvvuc5guynO6Sm3wgeKnrJdVA1wTf5EOQrLAw5LhQCp9cPYNst-20iZVl4_fEFX9sCXo7PyvfR7llBNg8E6cc8duMSZPjMu4CQOr2kJg8Mym05xcTmahTfZ8Eunf9T1ZB3vwt2xN7aP3v_vXKKy-PC22CobB1vIoRUQc2bMTyKsgyxb6w3g_J1SSyWfPc-aCa57x04bB-a8')}
                                    />
                                </div>
                            </div>
                            <div className="group text-center">
                                <div className="bg-white w-24 h-24 mx-auto rounded-full shadow-lg border-4 border-slate-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_3_icon"
                                        defaultContent="assignment_turned_in"
                                        isEditing={editMode}
                                        tagName="span"
                                        className="material-symbols-outlined text-4xl text-primary"
                                        initialContent={getContent('workflow', 'step_3_icon', 'assignment_turned_in')}
                                    />
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 mb-3">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_3_title"
                                        defaultContent="3. Relatório Acionável"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('workflow', 'step_3_title', '3. Relatório Acionável')}
                                    />
                                </h3>
                                <p className="text-slate-600 leading-relaxed px-4">
                                    <EditableContent
                                        section="workflow"
                                        contentKey="step_3_description"
                                        defaultContent="Receba relatórios abrangentes com recomendações claras para RH e documentação de conformidade legal."
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('workflow', 'step_3_description', 'Receba relatórios abrangentes com recomendações claras para RH e documentação de conformidade legal.')}
                                    />
                                </p>
                                <div className="mt-6 p-3 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-[#D1D1D6] mx-auto max-w-xs transform group-hover:-translate-y-1 transition-all">
                                    <EditableContent
                                        ...
                                        className="rounded shadow-sm opacity-90"
                                        alt="Final Report"
                                        initialContent={getContent('workflow', 'step_3_image', 'https://lh3.googleusercontent.com/aida-public/AB6AXuBr71OqVG7z_0wuFgTJliFvVZB_81WJVo30xePop1HLtN_TFQgyJ1wslW91IMgQ2GCBH1gDyOLellMcgIQXg09O7IPbtl46jrdr8IG2aLRLXwN7HTkTnRO3NrTJ6CrA_7cN11ZXUufO-ex239RriXl27_KBoaJZiSXN1WrSx8gBdCJUY_p9cXmmKw1z5uhUW9wywmgxzdTNoCZ4IxtuOdwHgnU4Qho06dGxffOXjWblblCxajOIdTJiS7jie7k1-2BbbW4_CAQubwM')}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="max-w-2xl">
                            <span className="text-primary font-bold text-sm uppercase tracking-widest mb-2 block">
                                <EditableContent
                                    section="benefits"
                                    contentKey="subtitle"
                                    defaultContent="Por Que Importa"
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('benefits', 'subtitle', 'Por Que Importa')}
                                />
                            </span>
                            <h2 className="text-3xl lg:text-4xl font-display font-bold text-slate-900">
                                <EditableContent
                                    section="benefits"
                                    contentKey="title"
                                    defaultContent="Cultivando uma Mentalidade Saudável"
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('benefits', 'title', 'Cultivando uma Mentalidade Saudável')}
                                />
                            </h2>
                            <p className="mt-4 text-slate-600 text-lg">
                                <EditableContent
                                    ...
                                    defaultContent="Além da conformidade, focamos no aspecto humano da sua organização. Mentes saudáveis levam a negócios resilientes."
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('benefits', 'description', 'Além da conformidade, focamos no aspecto humano da sua organização. Mentes saudáveis levam a negócios resilientes.')}
                                />
                            </p>
                        </div>
                    ...
                    <div className="text-center mb-16">
                        <span className="bg-white border border-slate-200 text-slate-600 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide shadow-sm">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('testimonials', 'chip_text', 'Impacto Real')}
                            />
                        </span>
                        <h2 className="text-3xl lg:text-4xl font-display font-bold text-slate-900 mt-4">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('testimonials', 'title', 'Aprovado por Diretores de RH')}
                            />
                        </h2>
                    </div>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <p className="text-slate-600 text-lg leading-relaxed italic mb-4">
                                    "<EditableContent
                                        ...
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('testimonials', 'review_1_text', 'A empatia no design combinada com o rigor dos dados é impressionante. Não apenas nos ajudou a cumprir uma exigência legal, mas realmente melhorou o moral da equipe em 3 meses.')}
                                    />"
                                </p>
                                <div>
                                    <h4 className="font-bold text-slate-900 text-lg">
                                        <EditableContent
                                            ...
                                            isEditing={editMode}
                                            tagName="span"
                                            initialContent={getContent('testimonials', 'review_1_author', 'Sarah Jenkins')}
                                        />
                                    </h4>
                                    <p className="text-sm text-slate-500">
                                        <EditableContent
                                            ...
                                            isEditing={editMode}
                                            tagName="span"
                                            initialContent={getContent('testimonials', 'review_1_role', 'Diretora de Pessoas & Cultura, TechFlow')}
                                        />
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <p className="text-slate-600 text-lg leading-relaxed italic mb-4">
                                    "<EditableContent
                                        ...
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('testimonials', 'review_2_text', 'Finalmente, uma ferramenta que respeita o tempo e a privacidade do funcionário, enquanto nos fornece o painel que precisamos para reuniões de diretoria. Os relatórios são detalhados e fáceis de ler.')}
                                    />"
                                </p>
                                <div>
                                    <h4 className="font-bold text-slate-900 text-lg">
                                        <EditableContent
                                            ...
                                            isEditing={editMode}
                                            tagName="span"
                                            initialContent={getContent('testimonials', 'review_2_author', 'Michael Chen')}
                                        />
                                    </h4>
                                    <p className="text-sm text-slate-500">
                                        <EditableContent
                                            ...
                                            isEditing={editMode}
                                            tagName="span"
                                            initialContent={getContent('testimonials', 'review_2_role', 'VP de RH, SOMA Construções')}
                                        />
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="text-center mb-16">
                        <span className="text-primary font-bold text-xs uppercase tracking-widest">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('pricing', 'chip_text', 'Preços')}
                            />
                        </span>
                        <h2 className="text-3xl lg:text-4xl font-display font-bold text-slate-900 mt-2 break-words px-4">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('pricing', 'title', 'Invista no Seu Pessoal')}
                            />
                        </h2>
                        <p className="mt-4 text-slate-500">
                            <EditableContent
                                ...
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('pricing', 'subtitle', 'Preços transparentes para empresas de todos os portes.')}
                            />
                        </p>
                    </div>
                        ...
                        <div className="relative flex flex-col rounded-2xl border border-slate-100 bg-white p-7 transition-all hover:shadow-lg group hover:border-primary">
                            <div className="flex flex-col gap-1 mb-8">
                                <h3 className="text-slate-400 text-xs font-bold uppercase tracking-wider">
                                    <EditableContent
                                        section="pricing"
                                        contentKey="plan_1_name"
                                        defaultContent="Pacote Mensal"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('pricing', 'plan_1_name', 'Pacote Mensal')}
                                    />
                                </h3>
                                <div className="flex flex-col">
                                    <p className="flex items-baseline gap-1 text-slate-800 mt-1">
                                        ...
                                        <span className="text-4xl font-extrabold tracking-tight">
                                            <EditableContent
                                                section="pricing"
                                                contentKey="plan_1_price"
                                                defaultContent="3.000,00"
                                                isEditing={editMode}
                                                tagName="span"
                                                initialContent={getContent('pricing', 'plan_1_price', '3.000,00')}
                                            />
                                        </span>
                                    </p>
                                    <span className="text-xs text-primary font-bold mt-2 px-2 py-0.5 bg-primary/5 rounded-md border border-primary/10 w-fit">
                                        R$ <EditableContent section="pricing" contentKey="plan_1_per_eval" defaultContent="10,00" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_1_per_eval', '10,00')} />/aval
                                    </span>
                                </div>
                                <ul className="text-left space-y-3 mt-6 text-sm text-slate-600">
                                    <li className="flex gap-2 items-center">
                                        <span className="material-symbols-outlined text-primary text-lg">check</span>
                                        <EditableContent section="pricing" contentKey="plan_1_feat_1" defaultContent="300 avaliações" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_1_feat_1', '300 avaliações')} />
                                    </li>
                                    <li className="flex gap-2 items-center">
                                        <span className="material-symbols-outlined text-primary text-lg">check</span>
                                        <EditableContent section="pricing" contentKey="plan_1_feat_2" defaultContent="Relatório de Conformidade Básico" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_1_feat_2', 'Relatório de Conformidade Básico')} />
                                    </li>
                                </ul>
                            </div>
                            <button
                        ...
                        <div className="relative flex flex-col rounded-2xl border-2 border-primary bg-white p-7 transition-all shadow-md scale-105 z-10">
                            ...
                            <div className="flex flex-col gap-1 mb-8">
                                <h3 className="text-slate-400 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
                                    <EditableContent
                                        section="pricing"
                                        contentKey="plan_2_name"
                                        defaultContent="Plano Anual"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('pricing', 'plan_2_name', 'Plano Anual')}
                                    />
                                ...
                                <div className="flex flex-col">
                                    <p className="flex items-baseline gap-1 text-slate-800 mt-1">
                                        ...
                                        <span className="text-5xl font-extrabold tracking-tight text-primary">
                                            <EditableContent
                                                section="pricing"
                                                contentKey="plan_2_price"
                                                defaultContent="6.000,00"
                                                isEditing={editMode}
                                                tagName="span"
                                                initialContent={getContent('pricing', 'plan_2_price', '6.000,00')}
                                            />
                                        </span>
                                    </p>
                                    <span className="text-xs text-primary font-bold mt-2 px-2 py-0.5 bg-primary/5 rounded-md border border-primary/10 w-fit">
                                        R$ <EditableContent section="pricing" contentKey="plan_2_per_eval" defaultContent="5,00" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_2_per_eval', '5,00')} />/aval
                                    </span>
                                </div>
                                <p className="text-primary text-xs font-bold mt-4 bg-primary/5 p-2 rounded-lg border border-primary/10">
                                    <EditableContent section="pricing" contentKey="plan_2_discount" defaultContent="Economize 50% com faturamento anual" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_2_discount', 'Economize 50% com faturamento anual')} />
                                </p>
                                <ul className="text-left space-y-3 mt-6 text-sm text-slate-600">
                                    <li className="flex gap-2 items-center">
                                        <span className="material-symbols-outlined text-primary text-lg">check</span>
                                        <EditableContent section="pricing" contentKey="plan_2_feat_1" defaultContent="Até 1.200 avaliações" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_2_feat_1', 'Até 1.200 avaliações')} />
                                    </li>
                                    <li className="flex gap-2 items-center">
                                        <span className="material-symbols-outlined text-primary text-lg">check</span>
                                        <EditableContent section="pricing" contentKey="plan_2_feat_2" defaultContent="Suíte Completa de Conformidade" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_2_feat_2', 'Suíte Completa de Conformidade')} />
                                    </li>
                                    <li className="flex gap-2 items-center">
                                        <span className="material-symbols-outlined text-primary text-lg">check</span>
                                        <EditableContent section="pricing" contentKey="plan_2_feat_3" defaultContent="Suporte Prioritário" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_2_feat_3', 'Suporte Prioritário')} />
                                    </li>
                                </ul>
                            </div>
                            <button
                        ...
                        <div className="relative flex flex-col rounded-2xl border border-slate-100 bg-white p-7 transition-all hover:shadow-lg group hover:border-primary">
                            <div className="flex flex-col gap-1 mb-8">
                                <h3 className="text-slate-400 text-xs font-bold uppercase tracking-wider">
                                    <EditableContent
                                        section="pricing"
                                        contentKey="plan_3_name"
                                        defaultContent="Pacote Semestral"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('pricing', 'plan_3_name', 'Pacote Semestral')}
                                    />
                                </h3>
                                <div className="flex flex-col">
                                    <p className="flex items-baseline gap-1 text-slate-800 mt-1">
                                ...
                                <ul className="text-left space-y-3 mt-6 text-sm text-slate-600">
                                    <li className="flex gap-2 items-center">
                                        <span className="material-symbols-outlined text-primary text-lg">check</span>
                                        <EditableContent section="pricing" contentKey="plan_3_feat_1" defaultContent="Até 500 avaliações" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_3_feat_1', 'Até 500 avaliações')} />
                                    </li>
                                    <li className="flex gap-2 items-center">
                                        <span className="material-symbols-outlined text-primary text-lg">check</span>
                                        <EditableContent section="pricing" contentKey="plan_3_feat_2" defaultContent="Relatórios Padrão" isEditing={editMode} tagName="span" initialContent={getContent('pricing', 'plan_3_feat_2', 'Relatórios Padrão')} />
                                    </li>
                                </ul>
                            </div>
                            <button
                    ...
                    <div className="text-center mb-16">
                        <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-wider mb-4">
                            <EditableContent
                                section="faq"
                                contentKey="chip"
                                defaultContent="Suporte & Dúvidas"
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('faq', 'chip', 'Suporte & Dúvidas')}
                            />
                        </span>
                        <h2 className="text-3xl lg:text-4xl font-display font-bold text-slate-900 mt-2">
                            <EditableContent
                                section="faq"
                                contentKey="title"
                                defaultContent="Perguntas Frequentes"
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('faq', 'title', 'Perguntas Frequentes')}
                            />
                        </h2>
                        <p className="mt-4 text-slate-500 max-w-2xl mx-auto">
                            <EditableContent
                                section="faq"
                                contentKey="subtitle"
                                defaultContent="Tudo o que você precisa saber sobre a implementação do Gama Psicossocial em sua operação."
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('faq', 'subtitle', 'Tudo o que você precisa saber sobre a implementação do Gama Psicossocial em sua operação.')}
                            />
                        </p>
                    </div>
                                ...
                                >
                                    <span className={`font-bold transition-colors break-words ${openFaqIndex === index ? 'text-primary' : 'text-slate-700'}`}>
                                        <EditableContent
                                            section="faq"
                                            contentKey={`q_${index}`}
                                            defaultContent={item.q}
                                            isEditing={editMode}
                                            tagName="span"
                                            initialContent={getContent('faq', `q_${index}`, item.q)}
                                        />
                                    </span>
                                ...
                                >
                                    <div className="px-4 sm:px-6 pb-6 text-slate-500 text-sm leading-relaxed border-t border-slate-50 pt-4 break-words">
                                        <EditableContent
                                            section="faq"
                                            contentKey={`a_${index}`}
                                            defaultContent={item.a}
                                            isEditing={editMode}
                                            tagName="span"
                                            initialContent={getContent('faq', `a_${index}`, item.a)}
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-span-1 md:col-span-1">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-slate-900 font-display font-bold text-xl tracking-tight">
                                    <EditableContent
                                        ...
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('footer', 'brand', 'Gama Center')}
                                    />
                                </span>
                            </div>
                            <p className="text-sm text-slate-500 leading-relaxed mb-6">
                                <EditableContent
                                    section="footer"
                                    contentKey="description"
                                    defaultContent="Preenchendo a lacuna entre os requisitos corporativos e as necessidades humanas. Tornamos a conformidade empática."
                                    isEditing={editMode}
                                    initialContent={getContent('footer', 'description', 'Preenchendo a lacuna entre os requisitos corporativos e as necessidades humanas. Tornamos a conformidade empática.')}
                                />
                            </p>
                        </div>
                        <div>
                            <h4 className="text-slate-900 font-bold mb-6">
                                <EditableContent
                                    section="footer"
                                    contentKey="col_3_title"
                                    defaultContent="Entre em Contato"
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('footer', 'col_3_title', 'Entre em Contato')}
                                />
                            </h4>
                            <ul className="space-y-3 text-sm">
                                <li className="flex items-center gap-2">
                                    ...
                                    <EditableContent
                                        ...
                                        defaultContent="gamacentersst@gmail.com"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('footer', 'contact_email', 'gamacentersst@gmail.com')}
                                    />
                                </li>
                                <li className="flex items-center gap-2">
                                    ...
                                    <EditableContent
                                        ...
                                        defaultContent="31 97192-0766"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('footer', 'contact_phone', '31 97192-0766')}
                                    />
                                </li>
                                <li className="mt-4 text-xs text-slate-400">
                                    <EditableContent
                                        section="footer"
                                        contentKey="address"
                                        defaultContent="R. Barão de Pouso Alegre, 90 - São Sebastiao, Conselheiro Lafaiete - MG, 36406-034"
                                        isEditing={editMode}
                                        tagName="span"
                                        initialContent={getContent('footer', 'address', 'R. Barão de Pouso Alegre, 90 - São Sebastiao, Conselheiro Lafaiete - MG, 36406-034')}
                                    />
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-400">
                        <p>
                            <EditableContent
                                ...
                                defaultContent="© 2023 Gama Center. Todos os direitos reservados."
                                isEditing={editMode}
                                tagName="span"
                                initialContent={getContent('footer', 'copyright', '© 2023 Gama Center. Todos os direitos reservados.')}
                            />
                        </p>
                        <div className="flex space-x-6 mt-4 md:mt-0">
                            <a className="hover:text-slate-600 transition-colors" href="#">
                                <EditableContent
                                    ...
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('footer', 'legal_1', 'Política de Privacidade')}
                                />
                            </a>
                            <a className="hover:text-slate-600 transition-colors" href="#">
                                <EditableContent
                                    section="footer"
                                    contentKey="legal_2"
                                    defaultContent="Termos de Serviço"
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('footer', 'legal_2', 'Termos de Serviço')}
                                />
                            </a>
                            <a className="hover:text-slate-600 transition-colors" href="#">
                                <EditableContent
                                    section="footer"
                                    contentKey="legal_3"
                                    defaultContent="Configurações de Cookies"
                                    isEditing={editMode}
                                    tagName="span"
                                    initialContent={getContent('footer', 'legal_3', 'Configurações de Cookies')}
                                />
                            </a>
                        </div>
                    </div>
