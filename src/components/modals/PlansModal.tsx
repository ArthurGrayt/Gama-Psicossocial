...
export const PlansModal: React.FC<PlansModalProps> = ({ isOpen, onClose, onPlanSelect }) => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm transition-all duration-300">
            <div className="max-w-6xl w-full bg-white rounded-[2rem] shadow-xl p-8 md:p-12 border border-slate-100 animate-in fade-in zoom-in-95 duration-300 relative max-h-[90vh] overflow-y-auto">
                <button
                    onClick={onClose}
