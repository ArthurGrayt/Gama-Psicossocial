...
export const PaymentModal: React.FC<PaymentModalProps> = ({ isOpen, onClose, selectedPackage }) => {
    ...
    return (
        ...
        <div className="fixed inset-0 z-[9999] flex items-end md:items-center justify-center p-0 md:p-4">
            ...
            {/* Container do Modal */}
            <div
                className="relative bg-white rounded-t-[2rem] md:rounded-[2rem] w-full max-w-6xl h-[94dvh] md:h-auto md:max-h-[95vh] grid grid-cols-1 lg:grid-cols-12 gap-0 md:gap-8 shadow-2xl overflow-hidden isolation-isolate animate-in slide-in-from-bottom-4 md:zoom-in-95 duration-300 border border-slate-100"
                style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}
            >
                {/* Scrollable Content Wrapper due to Grid layout */}
                <div className="contents lg:block overflow-y-auto lg:overflow-visible">
